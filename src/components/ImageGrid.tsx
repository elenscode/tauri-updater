...
//         try {
//             // 로딩 시작 표시
//             const newLoadingImages = new Set(loadingImagesRef.current).add(imageId);
//             loadingImagesRef.current = newLoadingImages;
//             setLoadingImages(newLoadingImages);

//             // 시뮬레이션 대기
//             await new Promise(r => setTimeout(r, 300));
//             const url = `https://picsum.photos/300/200?random=${imageId}`;

//             // 캐시에 저장
//             const newCache = new Map(imageCacheRef.current).set(imageId, url);
//             imageCacheRef.current = newCache;
//             setImageCache(newCache);

//             // 로딩 완료 표시
//             const updatedLoadingImages = new Set(loadingImagesRef.current);
//             updatedLoadingImages.delete(imageId);
//             loadingImagesRef.current = updatedLoadingImages;
...
//                     currentVisibleIds.push(`image-${imageIndex + 1}`);
//                 }
//             }
//         });

//         const imagesToLoad = currentVisibleIds.filter(id =>
...
//     }, [virtualItems, columns, totalCount, fetchImageUrl]);
...
//             loadVisibleImages();
//         }, 100);
//     }, [loadVisibleImages]);    // 가상 스크롤 아이템이나 컬럼이 변경될 때마다 이미지 로드
//     useEffect(() => {
//         loadVisibleImages();
//     }, [loadVisibleImages]);
